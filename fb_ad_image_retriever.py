...
class FacebookAdImageRetriever:
  ...
  def __init__(self, config):
    ...
    self.db_connection = get_database_connection(self.config)
  ...
  def construct_snapshot_urls(self, access_token, archive_ids):
    archive_id_to_snapshot_url = {}
  ...
  def search_for_image_url_by_regex(self, search_regex, ad_snapshot_text):
  ...
  def get_image_url(self, snapshot_url):
  ...
  def make_image_hash_file_path(self, image_hash):
  ...
  def get_image_dhash(self, image_bytes):
  ...
  def insert_hash_to_database(self, cursor, archive_id, image_dhash):
  ...
  def make_gcs_bucket_client(self, bucket_name, credentials_file):
    storage_client = storage.Client.from_service_account_json(credentials_file)
    bucket_client = storage_client.get_bucket(bucket_name)
    return bucket_client

  def store_image_in_google_bucket(self, bucket_client, image_dhash, image_bytes):
  ...
  def process_archive_images(self, cursor, access_token, archive_ids):
