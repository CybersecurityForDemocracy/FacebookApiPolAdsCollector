...
class DBInterface():
    ...
    def existing_ads(self):
        ...
        existing_ad_query = "select archive_id, ad_creative_link_title, ad_creative_link_caption,ad_creative_link_description,ad_creative_body from ads where ad_creative_link_title <> '' limit 10;"
